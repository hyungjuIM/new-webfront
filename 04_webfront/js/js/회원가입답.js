...
const nameMassage = document.getElementById("inputname");
inputName.addEventListener("change", function () {
  //   let inputname = document.getElementById("inputname");
  const regEx2 = /^[가-힣]{2,5}$/;
  if (regEx2.test(this.value)) {
    nameMassage.innerText = "정상입력";
    nameMassage.style.color = "green";
  } else {
    nameMassage.innerText = "한글만 입력하세요";
    nameMassage.style.color = "red";
  }
});
